...
var level2State = {
    ...
    addButfly: function()
    {
        var butfly = this.butflys.create(750,game.world.height-225,'lightbug');
   ...
   doubleJumpBool: false,
    ...
    create: function (){
     ...
     //  A simple background for our game
        game.add.sprite(0, 0, 'eveningSky');
        this.background = game.add.tileSprite(0, 0, 800, 600, 'eveningTrees');
        this.nearground = game.add.tileSprite(0, 0, 800, 600, 'eveningBrush');
